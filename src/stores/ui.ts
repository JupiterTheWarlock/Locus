...
export const useUiStore = defineStore("ui", () => {
  ...
  const settingsCategoryHint = ref<"api" | "models" | "permissions" | "codeAnalysis" | "hotReload" | "unityConnection" | "testing" | "proxy" | "general" | "experimental" | "display" | "notifications" | "shortcuts" | "archived" | "console" | "about" | null>(null);
